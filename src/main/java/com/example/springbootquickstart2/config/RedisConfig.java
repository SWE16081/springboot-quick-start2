...
* redisTemplate默认是 jdkSerializeable存储的是二进制的字节码
* */
@Configuration
...
//    }
//    @Bean
//    public RedisTemplate <Object, Student> stuRedisTemplate(RedisConnectionFactory redisConnectionFactory)throws UnknownHostException {
